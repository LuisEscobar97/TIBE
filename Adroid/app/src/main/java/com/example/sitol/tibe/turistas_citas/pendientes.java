...
import com.example.sitol.tibe.adaptadorLista.MyAdapter;
 ...
 * {@link pendientes.OnFragmentInteractionListener} interface
...
public class pendientes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        inicializarFirebase();
        mRecyclerView=v.findViewById(R.id.listaPendientes);
    ...
    public List<ObjCita> listarGuias(){
        ...
        databaseReference.child("Citas").orderByChild("id_turista").equalTo(NavegadorPrincipal.turista.getIdTurista()).addValueEventListener(new ValueEventListener() {
            @Override
